...
int ScrieOptiuni(int cuIntampinare,struct contact Agenda[]){
    nr_incercari--;
    if(!go)
    ...
    if(go) {
        ...
        printf("\n\n");
        printf("1. Adaugati o persoana\n");
        printf("2. Stergeti o persoana\n");
        printf("3. Vizualizati lista de persoane\n");
        ///Validari.
        ///Etichete.
        ///Filtrare si sortare.
        ///Campuri obligatorii.
        printf("0. Pentru a parasii aplicatia introduceti cifra 0\n");
        return 1;
    }
    else
    if(nr_incercari){
...
void AfiseazaMeniu(struct contact Agenda[]){
